...
mech = Browser()
team_url = "http://www.fantrax.com/newui/fantasy/teamRoster.go?teamId={}&leagueId={}&isSubmit=y".format(
    team_id, league_id
)
...
def write_players(players, team_file):
    with open(team_file, "wb") as team:
        csv_f = csv.writer(team, delimiter=" ", quoting=csv.QUOTE_NONE, escapechar="\\")
